    ...
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center ">
      ...
      <div className=" flex flex-col space-y-10">
        <h4 className=" text-4xl font-semibold text-center">
          ...
          <span className=" decoration-teal-500/50 underline">Let &lsquo;s Talk </span>
        </h4>

        <div>
          <div className="flex items-center space-x-5 justify-center">
            <PhoneIcon className="text-teal-500 h-7 w-7 animate-pulse" />
            <p className="text-2xl">+261 34 25 698 79</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <EnvelopeIcon className="text-teal-500 h-7 w-7 animate-pulse" />
            <p className="text-2xl"> arotianarandrianasolo@yahoo.com</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
